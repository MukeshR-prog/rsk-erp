  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 flex flex-col gap-6">
          ...
          <div className="p-6 bg-white dark:bg-slate-900 rounded-3xl border border-slate-100 dark:border-slate-850 flex flex-col items-center justify-center text-center">
            <span className="text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-wider block">
              Payment Settle Amount
            </span>
            <span className="text-4xl font-extrabold text-slate-905 dark:text-white block mt-2 tracking-tight">
          ...
          {/* Details list */}
          <Card title="Payment & Audit Details">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-sm mt-2">
              <div className="flex gap-3">
                ...
                <div className="flex flex-col">
                  <span className="text-xs text-slate-450 dark:text-slate-500 font-bold uppercase tracking-wide">Payment Date</span>
                  <span className="text-slate-800 dark:text-slate-205 font-semibold mt-0.5">
              ...
              <div className="flex gap-3">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-slate-800 dark:text-slate-205 font-mono font-bold mt-0.5">
        ...
        {/* Right column: Vendor and Invoice connections */}
        <div className="flex flex-col gap-6">
          {/* Supplier Profile card */}
          <Card title="Supplier Profile" subtitle="Vendor contact details">
            <div className="flex flex-col gap-3 mt-1.5 text-sm">
              ...
              {payment.contact.gstNumber && (
                <div>
                  <span className="text-xs text-slate-400 font-bold block">GSTIN</span>
              ...
              {payment.contact.address && (
                <div>
                  <span className="text-xs text-slate-400 font-bold block">Billing Address</span>
          ...
          <ModalDialog className="bg-white dark:bg-slate-950 p-6 rounded-2xl max-w-md w-full text-left">
            ...
            <ModalBody className="flex flex-col gap-4">
              <p className="text-sm font-medium text-slate-600 dark:text-slate-400">
                ...
                ? This operation is irreversible and will restore the bill outstanding balance due.
              </p>
