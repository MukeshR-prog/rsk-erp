...
const TradingReportsPageContent = nextDynamic(
  () => import("./content"),
  {
    ssr: false,
    loading: () => (
...
export default function TradingReportsPage() {
  return (
    <Suspense fallback={<div className="flex h-screen items-center justify-center text-slate-500">Loading trading P&L reports...</div>}>
      <TradingReportsPageContent />
    </Suspense>
  );
}
