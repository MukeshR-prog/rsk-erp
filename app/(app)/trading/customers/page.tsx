    ...
    return (
      <div className="flex flex-col gap-2.5 w-full">
        <div className="flex justify-between items-start">
          ...
          <span className={`font-bold text-sm ${item.outstandingBalance > 0 ? "text-emerald-600" : "text-slate-700"}`}>
...
export default function CustomersPage() {
  return (
    <Suspense fallback={<div className="flex h-screen items-center justify-center text-slate-500">Loading customers...</div>}>
